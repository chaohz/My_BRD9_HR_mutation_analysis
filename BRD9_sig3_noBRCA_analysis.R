...
patients_with_M_HRsig = intersect(patients_with_M_index, names(HR_sig_num))
HR_sig_num_with_M_HRsig = HR_sig_num[patients_with_M_HRsig]

#patients_with_M_HRsig_high = names(HR_sig_num_with_M_HRsig)[which(HR_sig_num_with_M_HRsig > fivenum(HR_sig_num_with_M_HRsig)[4])]

patients_with_M_HRsig_noBRCA = patients_with_M_HRsig#[-which(patients_with_BRCA_M_HRsig %in% patients_with_M_HRsig)]
HR_sig_num_with_M_HRsig_noBRCA = HR_sig_num_with_M_HRsig[patients_with_M_HRsig_noBRCA]
patients_with_BRD9_M_HRsig_noBRCA = intersect(patients_with_BRD9_M_HRsig, patients_with_M_HRsig_noBRCA)
m_threshold_high = fivenum(HR_sig_num_with_M_HRsig_noBRCA)[4]

mutation_array = data.frame(rep(0,length(patients_with_M_HRsig_noBRCA)))
rownames(mutation_array) = patients_with_M_HRsig_noBRCA 
names(mutation_array) = "mutation"
mutation_array[patients_with_BRD9_M_HRsig_noBRCA,] = 1

express_array = data.frame(rep(0,length(patients_with_M_HRsig_noBRCA)))
rownames(express_array) = patients_with_M_HRsig_noBRCA
names(express_array) = "expression"
express_array[which(HR_sig_num_with_M_HRsig_noBRCA > m_threshold_high), ] = 1
